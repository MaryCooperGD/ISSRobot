%==============================================
% WorldTheory.pl for actor avatar
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuavatar).	%%old version (deprecated)
actorobj(qatuavatar).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor avatar
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of avatar" ). 
...
%-------------------------------------------------
%  User static rules about avatar
%------------------------------------------------- 
/*
------------------------------------------------------------------------
