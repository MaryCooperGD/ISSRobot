%==============================================
% WorldTheory.pl for actor gundam
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatugundam).	%%old version (deprecated)
actorobj(qatugundam).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor gundam
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of gundam" ). 
...
%-------------------------------------------------
%  User static rules about gundam
%------------------------------------------------- 
/*
------------------------------------------------------------------------
