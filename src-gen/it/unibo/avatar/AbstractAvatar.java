...
public class AbstractAvatar extends QaRobotActor { 
...
protected IActorAction  action;
	...
	*/
    ...
    nPlanIter++;
    		...
    		parg = "loadTheory( \"./talkTheoryAvatar.pl\" )";
    		//tout=1 day (24 h)
    		...
    		temporaryStr = " \"START START START START\" ";
    		println( temporaryStr );  
    		//forward
    		if( ! execRobotMove("init","forward",100,0,5000, "" , "") ) break;
    		//backward
    		if( ! execRobotMove("init","backward",100,0,5000, "" , "") ) break;
    		temporaryStr = " \"ENDS\" ";
    		println( temporaryStr );  
    break;
    }//while
