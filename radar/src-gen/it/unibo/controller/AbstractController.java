	...
	protected IActorAction  action;
		...
		*/
	    ...
	    nPlanIter++;
	    		...
	    		if( ! planUtils.switchToPlan("tmp").getGoon() ) break;
	    break;
	    }//while
	    return returnValue;
	    }catch(Exception e){
	    ...
	    public boolean tmp() throws Exception{	//public to allow reflection
	    try{
	    	curPlanInExec =  "tmp";
	    	boolean returnValue = suspendWork;
	    while(true){
	    ...
	    return returnValue;
	       ...
	       //println( getName() + " plan=tmp WARNING:" + e.getMessage() );
	       QActorContext.terminateQActorSystem(this); 
	       return false;  
	    }
	    }
