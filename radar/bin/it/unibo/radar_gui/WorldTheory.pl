%==============================================
% WorldTheory.pl for actor radar_gui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadar_gui).	%%old version (deprecated)
actorobj(qaturadar_gui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radar_gui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radar_gui" ). 
...
%-------------------------------------------------
%  User static rules about radar_gui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
